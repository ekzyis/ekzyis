...
I didn’t remember. I don’t know what’s so hard about remembering it. Is it because I’m too hungry when I need to remember? It sounds so easy, but it must have been over a year since I wanted to do [this](https://stacker.news/items/956985), and I always forget to even start!

At least I remember what I ate: a hot Cuban sandwich from [Royal Blue Grocery](https://www.royalbluegrocery.com/specialties) and a Double Cheeseburger with Bacon from [Burger Bar](https://www.burgerbaraustin.com/) on Congress.
...
While sitting in my corner, I overheard [@bitcoinplebdev](https://stacker.news/bitcoinplebdev) sharing some advice with someone new to PlebLab. I started taking notes because I found it so interesting when [@bitcoinplebdev](https://stacker.news/bitcoinplebdev) talked about finding your 'edge in the market.' He went into different skill sets and mentioned Jameson Lopp. I'm not sure if I remember correctly, but I believe he said that Lopp had a unique skill set that allowed him to understand both users and tech—a combination most people lack.

_While writing this, I dug a little into [@lopp](https://stacker.news/lopp) and found [this](https://stacker.news/items/979650). I hope [@lopp](https://stacker.news/lopp) can forgive me._
...
[@bitcoinplebdev](https://stacker.news/bitcoinplebdev) also mentioned part of his own journey; he described it like this:
...
He then went on how he got into PlebLab. I didn't really get the whole story, but he mentioned how he stuck around outside PlebLab and Car would always see that [@bitcoinplebdev](https://stacker.news/bitcoinplebdev) was not here to fuck spiders.
...
I already had this idea for a while, but hearing [@bitcoinplebdev](https://stacker.news/bitcoinplebdev) talk again about his journey convinced me that I had to interview him like I interviewed [@plebpoet](https://stacker.news/plebpoet) [here](https://stacker.news/items/824438). I want to get his full story with answers to all my questions.
